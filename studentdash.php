...
<div  class="bgimg">
<center>
    <h1 id="non-printable" style="color:black;">View Result</h1>
<div id="non-printable">
		...
		<form action="#" method="POST">
            ...
            <table class="info">
                <tr>
               	    <td align="center">
                        <label style="color:black;font-weight: bold;">Enter Roll Number</label>
               	    </td>
               	    <td> 
                ...
                <tr>	   
                   	<td align="center">
               	        <label style="color:black;font-weight: bold;">Enter your D.O.B</label>
               	    </td> 
               	    <td>
...
<footer id="non-printable">
    <center><small>Copyright © Anshul july,2023</small></center>
</footer>
...
if(isset($_POST['search'])) {
    ...
    if($num_rows>0)
    {
        while($row=mysqli_fetch_array($res))
        {
            ...
            echo "<center><h1 id='details'style='color:black'>Student's Result</h1></center>";
            echo "<table cellspacing='0' class='box' align='center' border='0'>";
            echo "<tr>";
            echo "<td align='left' style='font-size:20px;padding-left:30px' class='res'>Student Name:</td>";
